...
module alustim();
	...
	initial begin
		...
		A = 64'hF0F0F0F0AB8191F2; B = 64'hF0F0F0F0AB8191F2;
		#(delay);
		assert(result == 64'hF0F0F0F0AB8191F2 && negative == 1 && zero == 0);
		A = 64'h5555555555555555; B = 64'hAAAAAAAAAAAAAAAA;
		#(delay);
		assert(result == 64'h0000000000000000 && negative == 0 && zero == 1);
		A = 64'h555555555555555A; B = 64'hAAAAAAAAAAAAAAAA;
		#(delay);
		assert(result == 64'h000000000000000A && negative == 0 && zero == 0);
		...
		#(delay);
		assert(result == 64'hFFFFFFFFFFFFFFFF && negative == 1 && zero == 0);
		A = 64'h0000000000000000; B = 64'h0FFFFFFFFFFFFFFF;
		#(delay);
		assert(result == 64'h0FFFFFFFFFFFFFFF && negative == 0 && zero == 0);
		...
		#(delay);
		assert(result == 64'hFFFFFFFFFFFFFFFF && negative == 1 && zero == 0);
		A = 64'hF000000000000000; B = 64'hFFFFFFFFFFFFFFFF;
		#(delay);
		assert(result == 64'h0FFFFFFFFFFFFFFF && negative == 0 && zero == 0);
